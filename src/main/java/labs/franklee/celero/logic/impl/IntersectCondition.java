...
public class IntersectCondition extends Condition {
    ...
    public IntersectCondition(String field1, String valueType1, String field2, String valueType2) {
        this.field1 = field1;
        this.field2 = field2;
    ...
    protected String generateName() {
        return "intersections of list(" + this.field1 + ") and list(" + this.field2 + ")";
    }
    ...
    public Condition negate() throws Exception {
        Condition condition = new DisjointCondition(this.field1, this.valueTypeStr1, this.field2, this.valueTypeStr2, this.getPriority(), this.isIgnoreAbsence());
        condition.build();
        return condition;
    }
}
